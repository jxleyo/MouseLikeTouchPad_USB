...
#define DRIVERNAME "MouseLikeTouchPad_UsbFilter.sys: "

#define CONFIDENCE_BIT 0x04

#define HIDUSB_POOL_TAG 'MLTP'
...
ULONG runtimes_FilterRequestCompletionRoutine;
UINT16 nCommonDescOffset;
BOOLEAN bDispatchDescComplete;
